...
class PlayActivity : AppCompatActivity() {
    ...
    private fun correctAlertDialog() {
        ...
        val view = LayoutInflater.from(this@PlayActivity).inflate(R.layout.correct_answers, null)
    ...
    private fun wrongAlertDialog() {
        val builder = AlertDialog.Builder(this@PlayActivity)
        val view = LayoutInflater.from(this@PlayActivity).inflate(R.layout.wong_answers, null)
        builder.setView(view)
